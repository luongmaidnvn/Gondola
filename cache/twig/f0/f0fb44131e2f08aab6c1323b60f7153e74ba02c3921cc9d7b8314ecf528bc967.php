...
class __TwigTemplate_00eefcb00c39d1495456dc52a48e7d327aabbcb711c5a01b4a0091e3caf22319 extends Twig_Template
{
  ...
  ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["field"]) {
            ...
            if (($this->getAttribute($context["field"], "type", array()) == "file")) {
                // line 39
                echo "        ";
                $this->getAttribute(($context["assets"] ?? null), "addJs", array(0 => "plugin://form/assets/form-custom.min.js"), "method");
                // line 40
                echo "    ";
            }
            // line 41
...
";
    ...
    ";
            // line 89
            $this->loadTemplate("forms/dropzone/template.html.twig", "forms/default/form.html.twig", 89)->display($context);
            // line 90
            echo "</div>
";
        }
...
>
  ...
  {% for field in form.fields %}
    {% if field.type == 'file' %}
        {% do assets.addJs('plugin://form/assets/form-custom.min.js') %}
    {% endif %}
...
{% endif %}
", "forms/default/form.html.twig", "/Applications/XAMPP/xamppfiles/htdocs/gondola/user/plugins/form/templates/forms/default/form.html.twig");
    }
}
