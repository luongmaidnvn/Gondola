...
return [
    ...
    'timestamp' => 1548240291,
    'checksum' => '3ab3d63d74afd196f8d43abaa455c6d6',
    'files' => [
        ...
        'user/plugins' => [
            ...
            'plugins/file-content' => [
                'file' => 'user/plugins/file-content/blueprints.yaml',
                'modified' => 1534495330
            ],
            'plugins/form' => [
            ...
            'plugins/google-tag-manager' => [
                'file' => 'user/plugins/google-tag-manager/blueprints.yaml',
                'modified' => 1534912676
            ],
            'plugins/login' => [
    ...
    'data' => [
        'items' => [
            ...
            'plugins.file-content.enabled' => [
                ...
                'name' => 'plugins.file-content.enabled',
                'validation' => 'strict'
            ],
            'plugins.file-content.allow_in_page' => [
                'type' => 'toggle',
                'label' => 'Allow in page',
                'highlight' => 1,
                'default' => 1,
                ...
                'name' => 'plugins.file-content.allow_in_page',
                'validation' => 'strict'
            ],
            'plugins.file-content.allow_in_grav' => [
                'type' => 'toggle',
                'label' => 'Allow in Grav',
                'highlight' => 1,
                'default' => 1,
                ...
                'name' => 'plugins.file-content.allow_in_grav',
                'validation' => 'strict'
            ],
            'plugins.file-content.allow_in_filesystem' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.file-content.allow_in_filesystem',
                'validation' => 'strict'
            ],
            'plugins.file-content.allowed_extensions' => [
                'type' => 'selectize',
                'size' => 'large',
                ...
                'name' => 'plugins.file-content.allowed_extensions',
                'validation' => 'strict'
            ],
            'plugins.form' => [
                'type' => '_root',
            ...
            'plugins.google-tag-manager.enabled' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.google-tag-manager.enabled',
                'validation' => 'strict'
            ],
            'plugins.google-tag-manager.trackingId' => [
                'type' => 'text',
                'label' => 'PLUGIN_GRAV_GTM.TACKING_ID',
                'validate' => [
                    'required' => true
                ],
                'name' => 'plugins.google-tag-manager.trackingId',
                'validation' => 'strict'
            ],
            'plugins.google-tag-manager.domains' => [
                'type' => 'array',
                'size' => 'large',
                'label' => 'PLUGIN_GRAV_GTM.APPLY_ONLY',
                'value_only' => true,
                'name' => 'plugins.google-tag-manager.domains',
                'validation' => 'strict'
            ],
            'plugins.login' => [
                'type' => '_root',
        ...
        'nested' => [
            ...
            'plugins' => [
                ...
                'file-content' => [
                    'enabled' => 'plugins.file-content.enabled',
                    'allow_in_page' => 'plugins.file-content.allow_in_page',
                    'allow_in_grav' => 'plugins.file-content.allow_in_grav',
                    'allow_in_filesystem' => 'plugins.file-content.allow_in_filesystem',
                    'allowed_extensions' => 'plugins.file-content.allowed_extensions'
                ],
                'form' => [
                ...
                'google-tag-manager' => [
                    'enabled' => 'plugins.google-tag-manager.enabled',
                    'trackingId' => 'plugins.google-tag-manager.trackingId',
                    'domains' => 'plugins.google-tag-manager.domains'
                ],
                'login' => [
